...
namespace chess
{
  static const char STR_WHITE_TURN[] = "Luot quan trang";
  static const char STR_BLACK_TURN[] = "Luot quan den";
  static const char STR_BLACK_WIN[] = "Quan den thang!";
  static const char STR_WHITE_WIN[] = "Quan trang thang!";
  static const char STR_STALEMATE[] = "Hoa!";
