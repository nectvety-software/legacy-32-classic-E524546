...
const char STR_TRANSMITTER_STATE[] = "Trang thai WiFi";
const char STR_START_SCAN[] = "Bat dau quet";
const char STR_START_SCAN_ERR[] = "Loi quet WiFi";
const char STR_WIFI_BUSY[] = "WiFi dang ban";
const char STR_DISCONNECT[] = "Ngat ket noi";
const char STR_FORGET[] = "Quen mang";
const char STR_CONNECTING[] = "Dang ket noi...";
const char STR_CONNECT_ERR[] = "Loi ket noi";
...
void WiFiContext::showMainTmpl()
{
  ...
  wifi_state_item->setFocusBorderColor(COLOR_ACCENT);
...
void WiFiContext::showContextMenuTmpl()
{
  ...
  _context_menu->setBorderColor(COLOR_ACCENT);
