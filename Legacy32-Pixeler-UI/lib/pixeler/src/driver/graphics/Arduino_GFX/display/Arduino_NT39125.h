...
static const uint8_t nt39125_init_operations[] = {
    ...
    BEGIN_WRITE,
    WRITE_C8_D8,
    NT39125_TEOFF,  // Tearing Effect Line OFF
    WRITE_C8_D16,
    NT39125_FRMCTR1,
    0x11,
    0x1b,  // Set Division ratio for internal clocks of Normal mode
    WRITE_C8_D16,
    NT39125_FRMCTR2,
    0x11,
    0x1b,  // Set Division ratio for internal clocks of Idle mode
    WRITE_C8_D16,
    NT39125_FRMCTR3,
    0x11,
    0x1b,  // Set Division ratio for internal clocks of Partial mode (Idle mode off)
    WRITE_C8_D8,
    NT39125_INVCTR,
    0x02,  // Inversion Control
    WRITE_C8_D16,
    NT39125_DISSET5,
    0x01,
    0x02,  // Display Function set 5
    WRITE_C8_D8,
    NT39125_PWCTR1,
    0x24,  // Power Control 1, 4.1V

    // VGL -7V
    WRITE_C8_D16,
    NT39125_PWCTR2,
    0x02,
    0x00,  // Power Control 2
    ...
    NT39125_PWCTR3,
    0x05,
    0x01,  // Power Control 3 (in Normal mode/ Full colors), e1 setting
    WRITE_C8_D16,
    NT39125_PWCTR4,
    0x02,
    0x05,  // Power Control 4 (in Idle mode/ 8-colors)
    WRITE_C8_D16,
    NT39125_PWCTR5,
    0x02,
    0x04,  // Power Control 5 (in Partial mode/ full-colors)
    WRITE_C8_D16,
    NT39125_VMCTR1,  // VCOM Control, Chameleon
    0x14,            // 3   	.	 VcomH
    0x2e,            // -1.35	.VcomL
    WRITE_C8_D8,
    NT39125_GAM_R_SEL,
    0x01,  // Gamma Selection

    ///////////////////////////////////////// gamma //////////////////////

    WRITE_COMMAND_8,
    NT39125_GMCTRP0,  // Positive RED Gamma Control, d1 third vibration
    WRITE_BYTES,
    15,
    0x27,
    0x2B,
    ...
    WRITE_COMMAND_8,
    NT39125_GMCTRN0,  // Negative RED Gamma Control
    WRITE_BYTES,
    15,
    0x08,
    0x21,
    ...
    WRITE_COMMAND_8,
    NT39125_GMCTRP1,  // Positive GREEN Gamma Control
    WRITE_BYTES,
    15,
    0x27,
    0x2C,
    ...
    WRITE_COMMAND_8,
    NT39125_GMCTRN1,  // Negative GREEN Gamma Control
    WRITE_BYTES,
    15,
    0x08,
    0x20,
    ...
    WRITE_COMMAND_8,
    NT39125_GMCTRP2,  // Positive BLUE Gamma Control
    WRITE_BYTES,
    15,
    0x1F,
    0x24,
    ...
    WRITE_COMMAND_8,
    NT39125_GMCTRN2,  // Negative BLUE Gamma Control
    WRITE_BYTES,
    15,
    0x08,
    0x24,
    ...
    WRITE_C8_D8,
    0x3A,
    0x55,  // Color mode, 16-bit

    WRITE_COMMAND_8,
    0x11,  // SLEEP MODE OUT / BOOSTER ON
    END_WRITE,
...
public:
  Arduino_NT39125(
      ...
      uint8_t r = 0,
      bool ips = false,
      int16_t w = NT39125_TFTWIDTH,
      int16_t h = NT39125_TFTHEIGHT,
