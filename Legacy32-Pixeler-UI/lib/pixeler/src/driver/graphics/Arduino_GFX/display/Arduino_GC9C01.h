...
static const uint8_t gc9c01_init_operations[] = {
    ...
    WRITE_C8_D8,
    0x80,
    0x11,  // reg_en for 70\74
    WRITE_C8_D8,
    0x81,
    0x70,  // reg_en for 7C\7D\7E
    WRITE_C8_D8,
    0x82,
    0x09,  // reg_en for 90\93
    WRITE_C8_D8,
    0x83,
    0x03,  // reg_en for 98\99
    WRITE_C8_D8,
    0x84,
    0x20,  // reg_en for B5
    WRITE_C8_D8,
    0x85,
    0x42,  // reg_en for B9\BE
    WRITE_C8_D8,
    0x86,
    0xfc,  // reg_en for C2~7
    WRITE_C8_D8,
    0x87,
    0x09,  // reg_en for C8\CB
    WRITE_C8_D8,
    0x89,
    0x10,  // reg_en for EC
    WRITE_C8_D8,
    0x8A,
    0x4f,  // reg_en for F0~3\F6
    WRITE_C8_D8,
    0x8C,
    0x59,  // reg_en for 60\63\64\66
    WRITE_C8_D8,
    0x8D,
    0x51,  // reg_en for 68\6C\6E
    WRITE_C8_D8,
    0x8E,
    0xae,  // reg_en for A1~3\A5\A7
    WRITE_C8_D8,
    0x8F,
    0xf3,  // reg_en for AC~F\A8\A9
    WRITE_C8_D8,
    0x36,
    0x00,
    WRITE_C8_D8,
    ...
    WRITE_C8_D8,
    0xA8,
    0x5E,  // VBG_BUF=1.003V, DVDD=1.543V
    WRITE_C8_D8,
    0xA7,
    0x40,  // BIAS=10.2uA
    WRITE_C8_D8,
    0xAF,
    0x73,  // VDDSOU=1.715V ,VDDGM=2.002V
    WRITE_C8_D8,
    0xAE,
    0x44,  // VREE=2.475V,VRDD=2.335V
    WRITE_C8_D8,
    0xAD,
    0x38,  // VRGL=1.635V ,VDDSF=2.018V
    WRITE_C8_D8,
    0xA3,
    0x5D,  // OSC=53.7MHz
    WRITE_C8_D8,
    0xC2,
    0x02,  // VREG_VREF=2.805V
    WRITE_C8_D8,
    0xC5,
    0x11,  // VREG1A=5.99V
    WRITE_C8_D8,
    ...
    0x00,
    0x00,
    0x07,  // gout4_swap_fw[4:0]
    0x01,
    0x13,
    0x11,
    0x0B,  // gout8_swap_fw[4:0]
    0x09,
    0x16,
    0x15,
    0x1D,  // gout12_swap_fw[4:0]
    0x1E,
    0x00,
    0x00,
    0x00,  // gout16_swap_fw[4:0]
    0x00,
    0x00,
    0x00,
    0x1E,  // gout20_swap_fw[4:0]
    0x1D,
    0x15,
    0x16,
    0x0A,  // gout24_swap_fw[4:0]
    0x0C,
    0x12,
    0x14,
    0x02,  // gout28_swap_fw[4:0]
    0x08,
    0x00,
    0x00,
    0x00,  // gout32_swap_fw[4:0]
    ...
    0x06,
    0x09,
    0x05,  // vgh_clk_porch  0E
    0x0C,
    0x06,  // vcl_clk_porch  0E
...
public:
  Arduino_GC9C01(
      ...
      uint8_t r = 0,
      bool ips = false,
      int16_t w = GC9C01_TFTWIDTH,
      int16_t h = GC9C01_TFTHEIGHT,
