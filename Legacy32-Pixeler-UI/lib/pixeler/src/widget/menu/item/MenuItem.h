...
namespace pixeler
{
  ...
  public:
    ...
    /**
     * @brief Вмикає вертикальне компонування комірки: іконка зверху, підпис знизу.
     * Використовується для сітки іконок у стилі Symbian S60.
     *
     * @param state Якщо true - іконка малюється зверху по центру, підпис під нею.
     */
    void setVerticalLayout(bool state);
