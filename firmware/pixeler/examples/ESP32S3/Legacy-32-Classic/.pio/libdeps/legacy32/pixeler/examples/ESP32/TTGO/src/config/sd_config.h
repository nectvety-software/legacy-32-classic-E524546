...
#define SDSPI_BUS VSPI  // Номер шини SPI
#define SDSPI_PIN_CS 5  // Бібліотека карти пам'яті вимагає реальний пін, навіть у випадку, якщо CS приєдано до землі.
#define SDSPI_PIN_MOSI 23
#define SDSPI_PIN_SCLK 18
#define SDSPI_PIN_MISO 19
