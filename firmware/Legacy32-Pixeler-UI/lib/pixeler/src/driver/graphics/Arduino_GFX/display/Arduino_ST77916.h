...
public:
  Arduino_ST77916(
      ...
      uint8_t r = 0,
      bool ips = false,
      int16_t w = ST77916_TFTWIDTH,
      int16_t h = ST77916_TFTHEIGHT,
      uint8_t col_offset1 = 0,
      uint8_t row_offset1 = 0,
      uint8_t col_offset2 = 0,
      uint8_t row_offset2 = 0,
      const uint8_t* init_operations = st77916_180_init_operations,
      size_t init_operations_len = sizeof(st77916_180_init_operations));
