...
static const uint8_t r61529_init_operations[] = {
    ...
    WRITE_C8_D8,
    R61529_DISPMODE,
    0x00,  // Display Mode, Uses internal oscillator

    WRITE_COMMAND_8,
    R61529_PDS,  // Panel Driving Setting;
    WRITE_BYTES,
    8,
    ...
    WRITE_COMMAND_8,
    R61529_DTSFNM,  // Display Timing Setting for Normal Mode
    WRITE_BYTES,
    5,
    ...
    WRITE_COMMAND_8,
    R61529_SGDTS,  // Source/Gate Driving Timing Setting
    WRITE_BYTES,
    4,
    ...
    WRITE_C8_D8,
    R61529_DPIPCTL,
    0x04,  // DPI polarity control, VSYNC -Active Low. HSYNC - Active Low. DE pin enable data write in when DE=1. Reads data on the rising edge of the PCLK signal.
    ...
    WRITE_COMMAND_8,
    R61529_NVMAC,  // NVM Access Control
    WRITE_BYTES,
    3,
    ...
    WRITE_COMMAND_8,
    R61529_SETDDBWRCTL,  // set_DDB_write_control
    WRITE_BYTES,
    6,
    0x00,
    0x00,
    ...
    WRITE_C8_D8,
    R61529_NVMLC,
    0x00,  // NVM Load Control, does not execute data load from the NVM to each command

    WRITE_C8_D8,
    0x3A,
    0x55,  // set_pixel_format, 16-Bit/pixel = 55h, 24-bit/pixel = 77h
