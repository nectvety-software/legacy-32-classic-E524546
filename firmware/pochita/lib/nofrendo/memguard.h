...
/* Pull in the real allocator/string prototypes BEFORE the macros below
** shadow malloc/free/strdup. Their include guards then keep any later
** (transitive) inclusion of these system headers from being macro-mangled,
** which otherwise breaks compilation on newlib toolchains (ESP32). */
#include <stdlib.h>
#include <string.h>
