...
Arduino_ESP32PAR16QQ::Arduino_ESP32PAR16QQ(
    ...
    int8_t d14,
    int8_t d15)
    : _dc(dc), _cs(cs), _wr(wr), _rd(rd), _d0(d0), _d1(d1), _d2(d2), _d3(d3), _d4(d4), _d5(d5), _d6(d6), _d7(d7), _d8(d8), _d9(d9), _d10(d10), _d11(d11), _d12(d12), _d13(d13), _d14(d14), _d15(d15)
{
}
...
void Arduino_ESP32PAR16QQ::writePixels(const uint16_t* data, uint32_t len)
{
  while (len--)
  {
    WRITE16(*data++);
...
void Arduino_ESP32PAR16QQ::writeBytes(const uint8_t* data, uint32_t len)
{
  while (len > 1)
  {
    _data16.msb = *data++;
