...
public:
  Arduino_NV3007(
      ...
      uint8_t r = 0,
      bool ips = false,
      int16_t w = NV3007_TFTWIDTH,
      int16_t h = NV3007_TFTHEIGHT,
      uint8_t col_offset1 = 0,
      uint8_t row_offset1 = 0,
      uint8_t col_offset2 = 0,
      uint8_t row_offset2 = 0,
      const uint8_t* init_operations = nv3007_init_operations,
      size_t init_operations_len = sizeof(nv3007_init_operations));
