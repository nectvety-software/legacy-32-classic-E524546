# build_sim.ps1 — build espbrowser_sim.exe (MinGW g++, static)
...
& $gpp -O2 -std=gnu++17 -static -I shims -I "$root\include" `
  -o espbrowser_sim.exe `
...
Write-Host "OK -> $PSScriptRoot\espbrowser_sim.exe"
