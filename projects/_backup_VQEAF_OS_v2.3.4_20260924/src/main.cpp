...
static AppContext appCtx{ui, storage, settings, music, keyboard, notifications, systemService, wifiProfiles, wifiConnection, browserService, imageViewer, shellService, themeFiles, appInstaller};
...
static void enterScreen(ScreenId s, bool animate = true, bool resume = false) {
  ...
  switch (s) {
    ...
    case ScreenId::About:
      ...
      ui.message("VQEAF OS", "v2.3.4 Pixel Icons", "ESP32-S3 / 240x320 portrait", "Browser, .vqeaf, .qeapp");
      ui.softkeys("", "", "Back");
      break;
    default: break;
  }
...
static void drawSplash() {
  ...
  d.setCursor(52,229); d.print("VQEAF OS v2.3.4");
}
