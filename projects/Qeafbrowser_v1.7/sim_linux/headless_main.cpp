...
int main(int argc,char**argv){mkdir("sim_lfs",0777);mkdir("sim_lfs/Qeafbrowser",0777);mkdir("sim_sd",0777);FILE*f=fopen("sim_lfs/Qeafbrowser/config.ini","w");fprintf(f,"wifi_ssid=VNPT-Home\nwifi_pass=abc\nhome_url=https://qeafivels.com/\n");fclose(f);setup();pump(100);shot("01_home");
