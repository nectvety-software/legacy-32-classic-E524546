...
class H(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path=='/home':
            ...
            self.body(200, f'''<!doctype html><html><head><title>Qeafbrowser Test Portal</title><style>.x{{color:red}}</style><script>BAD_SCRIPT_TEXT</script></head><body><a href="/article">Open Article</a><br><b>HTTP redirect OK</b><br>Cookie: {ck}<br><img alt="Qeafbrowser logo" src="/logo.png"><br><a href="relative/info.html">Relative Info</a></body></html>'''); return
